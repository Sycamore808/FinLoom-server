...
class ResponseGenerator:
    ...
    RESPONSE_TEMPLATES = {
        ...
        "goodbye": [
            ...
            {"text": "再见！期待下次为您服务。", "tone": "casual", "variables": []},
        ],
    }
    ...
    def generate_response(
        ...
        templates = self.RESPONSE_TEMPLATES.get(
            intent, self.RESPONSE_TEMPLATES["error"]
        )
    ...
    def generate_structured_response(
        self, intent: str, data: Dict[str, Any], format: str = "text"
    ) -> str:
        """生成结构化响应
    ...
    def generate_error_response(
        self, error_type: str, error_details: Optional[str] = None
    ) -> str:
        """生成错误响应
    ...
    def generate_clarification_response(self, missing_info: List[str]) -> str:
        """生成澄清请求响应
    ...
    def _generate_text_response(self, intent: str, data: Dict[str, Any]) -> str:
        """生成纯文本响应
    ...
    def _generate_markdown_response(self, intent: str, data: Dict[str, Any]) -> str:
        """生成Markdown格式响应
    ...
    def _generate_html_response(self, intent: str, data: Dict[str, Any]) -> str:
        """生成HTML格式响应
...
# 模块级别函数
def create_response_generator(tone: str = "formal") -> ResponseGenerator:
    """创建响应生成器实例
...
def generate_quick_response(intent: str, entities: Dict[str, Any] = None) -> str:
    """生成快速响应的便捷函数
